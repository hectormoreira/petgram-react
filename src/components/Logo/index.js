  ...
  <Link to="/">
    ...
    >
      <defs>
        ...
        >
          <stop offset={0} stopColor="#0049ff" />
          <stop offset={1} stopColor="#1cadad" />
        </linearGradient>
        <filter
        ...
        >
          ...
          <feComposite
            ...
            result="shadow"
          />
          <feOffset dx={-4} dy={-1.2} in="SourceGraphic" result="offset-1" />
          <feOffset dx={4} dy={1.2} in="shadow" result="offset-2" />
          <feMerge>
